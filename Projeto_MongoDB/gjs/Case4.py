...
lista_treinadores =[
    ...
    },
    {
        ...
        "nome": "Misty",
        "pokemons": [
            {"id_pokemon": {"num_especie": 121, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 54, "id_natureza": 1}, "rota": "Rota 24", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 118, "id_natureza": 1}, "rota": "Rota 6", "regiao": "Kanto"}
        ]
    },
    {
        "_id": 3,
        "nome": "Brock",
        "pokemons": [
            {"id_pokemon": {"num_especie": 95, "id_natureza": 1}, "rota": "Rock Tunnel", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 74, "id_natureza": 1}, "rota": "Mt. Moon", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 37, "id_natureza": 1}, "rota": "Rota 7", "regiao": "Kanto"}
        ]
    },
    {
        "_id": 4,
        "nome": "Gary Oak",
        "pokemons": [
            {"id_pokemon": {"num_especie": 9, "id_natureza": 2}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 59, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 65, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 18, "id_natureza": 2}, "rota": None, "regiao": "Kanto"}
        ]
    },
    {
        "_id": 5,
        "nome": "Red",
        "pokemons": [
            {"id_pokemon": {"num_especie": 3, "id_natureza": 2}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 25, "id_natureza": 2}, "rota": "Viridian Forest", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 143, "id_natureza": 1}, "rota": "Rota 12", "regiao": "Kanto"}
        ]
    },
    {
        "_id": 6,
        "nome": "Blue",
        "pokemons": [
            {"id_pokemon": {"num_especie": 6, "id_natureza": 2}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 112, "id_natureza": 1}, "rota": "Cerulean Cave", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 103, "id_natureza": 1}, "rota": None, "regiao": "Kanto"}
        ]
    },
    {
        "_id": 7,
        "nome": "Erika",
        "pokemons": [
            {"id_pokemon": {"num_especie": 45, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 114, "id_natureza": 1}, "rota": "Rota 21", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 71, "id_natureza": 1}, "rota": None, "regiao": "Kanto"}
        ]
    },
    {
        "_id": 8,
        "nome": "Lt. Surge",
        "pokemons": [
            {"id_pokemon": {"num_especie": 26, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 101, "id_natureza": 1}, "rota": "Power Plant", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 82, "id_natureza": 1}, "rota": "Power Plant", "regiao": "Kanto"}
        ]
    },
    {
        "_id": 9,
        "nome": "Sabrina",
        "pokemons": [
            {"id_pokemon": {"num_especie": 65, "id_natureza": 2}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 49, "id_natureza": 1}, "rota": "Cerulean Cave", "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 122, "id_natureza": 1}, "rota": "Rota 2", "regiao": "Kanto"}
        ]
    },
    {
        "_id": 10,
        "nome": "Giovanni",
        "pokemons": [
            {"id_pokemon": {"num_especie": 53, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 34, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
            {"id_pokemon": {"num_especie": 112, "id_natureza": 2}, "rota": "Cerulean Cave", "regiao": "Kanto"}
        ]
    }
]
...
# treinador = treinadores.find_one(filter_treinador)
# if treinador:
#     for pokemon_ref in treinador["pokemons"]:
#         especie = especies.find_one({"_id": pokemon_ref["id_pokemon"]["num_especie"]})
#         if especie:
#             print(f"Pokemon: {especie['nome']}, N°_pokedex: {pokemon_ref['id_pokemon']['num_especie']}, Id_natureza: {pokemon_ref['id_pokemon']['id_natureza']}, Tipos: {', '.join(especie['tipos'])}, ")
...
def consultar_pokemons():
    while True:
        ...
        try:
            ...
            if cursor_treinador:
                print("-" * 20)
                for pokemon_ref in cursor_treinador["pokemons"]:
                    especie = especies.find_one({"_id": pokemon_ref["id_pokemon"]["num_especie"]})
                    if especie:
                        print(f"Pokemon: {especie['nome']}, N°_pokedex: {pokemon_ref['id_pokemon']['num_especie']}, Id_natureza: {pokemon_ref['id_pokemon']['id_natureza']}, Tipos: {', '.join(especie['tipos'])}, Rota: {pokemon_ref['rota']}, Regiao: {pokemon_ref['regiao']}")
                print("-" * 20)
            else:
