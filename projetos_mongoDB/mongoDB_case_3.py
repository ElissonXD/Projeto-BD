...
lista_pokemons = [
    ...
    {"_id": {"num_especie": 3, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_especie": 18, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_especie": 131, "id_natureza": 1}, "rota": "Silph Co.", "regiao": "Kanto"},
    ...
    # Pokémon de Erika
    {"_id": {"num_especie": 45, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_especie": 114, "id_natureza": 1}, "rota": "Rota 21", "regiao": "Kanto"},
    {"_id": {"num_especie": 71, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    
    # Pokémon de Lt. Surge
    {"_id": {"num_especie": 26, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_especie": 101, "id_natureza": 1}, "rota": "Power Plant", "regiao": "Kanto"},
    {"_id": {"num_especie": 82, "id_natureza": 1}, "rota": "Power Plant", "regiao": "Kanto"},
    
    # Pokémon de Sabrina
    {"_id": {"num_especie": 65, "id_natureza": 2}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_specie": 49, "id_natureza": 1}, "rota": "Cerulean Cave", "regiao": "Kanto"},
    {"_id": {"num_specie": 122, "id_natureza": 1}, "rota": "Rota 2", "regiao": "Kanto"},
    
    # Pokémon de Giovanni
    {"_id": {"num_specie": 53, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_specie": 34, "id_natureza": 1}, "rota": None, "regiao": "Kanto"},
    {"_id": {"num_specie": 112, "id_natureza": 2}, "rota": "Cerulean Cave", "regiao": "Kanto"}
]
...
lista_treinadores =[
    ...
    },
    {
        ...
        "nome": "Erika", 
        "pokemon_refs": [
            {"num_especie": 45, "id_natureza": 1},
            {"num_especie": 114, "id_natureza": 1},
            {"num_especie": 71, "id_natureza": 1}
        ]
    },
    {
        "_id": 8, 
        "nome": "Lt. Surge", 
        "pokemon_refs": [
            {"num_especie": 26, "id_natureza": 1},
            {"num_especie": 101, "id_natureza": 1},
            {"num_especie": 82, "id_natureza": 1}
        ]
    },
    {
        "_id": 9, 
        "nome": "Sabrina", 
        "pokemon_refs": [
            {"num_especie": 65, "id_natureza": 2},
            {"num_especie": 49, "id_natureza": 1},
            {"num_especie": 122, "id_natureza": 1}
        ]
    },
    {
        "_id": 10, 
        "nome": "Giovanni", 
        "pokemon_refs": [
            {"num_especie": 53, "id_natureza": 1},
            {"num_especie": 34, "id_natureza": 1},
            {"num_especie": 112, "id_natureza": 2}
        ]
    }
...
# if treinador:
#     for pokemon_ref in treinador["pokemon_refs"]:
